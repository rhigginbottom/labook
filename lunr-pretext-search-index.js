...
},
{
  ...
  "number": "2.3.1",
  "title": "",
  "body": "  For each of the following, determine whether the given subset is a real vector space, using the usual operations of vector addition and scalar multiplication in .                        No, this is not a vector space. For example, it is not closed under scalar multiplication. We can see that .    No, this is not a vector space. For example, it is not closed under addition. We can see that .    Yes, this is a vector space. All of the vector space axioms hold.      "
},
{
  "id": "exercises-2-3-2",
  "level": "2",
