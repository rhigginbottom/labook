...
},
{
  ...
  "number": "1.1.9",
  "title": "",
  "body": "  We first consider the linear system consisting of two simple equations where the solution to each equation is a line in : . Readers will likely realize that the solution to this system happens when the graphs of these lines intersect. We see from the graph below that the intersection occurs at the point . Since this is the only intersection point, there is only one solution to this system.    The graph of two lines on coordinate axes. The lines have slopes 1 and -2. The lines meet at the point (2,1).   The graph of two lines plotted on coordinate axes. The horizontal axis ranges from to and the vertical axis ranges from to . One line has slope and -intercept and the other line has slope and -intercept . The lines intersect at the point . The lines are labeled with their defining equations.      We now consider a second linear system: . The graphs of these two lines appear below, but in this case the lines do not intersect at all because they are parallel. (The slope of both lines is .)    The graph of two lines on coordinate axes. The lines both have slopes -2. The lines are parallel and do not intersect.   The graph of two lines plotted on coordinate axes. The horizontal axis ranges from to and the vertical axis ranges from to . One line has slope and -intercept and the other line has slope and -intercept . The lines are parallel and do not intersect. The lines are labeled with their defining equations.      Here is a third linear system in two variables: . Each of these equations has a solution set whose graph is a line. In this particular case, we obtain the same line for both equations, which means that the linear system has an infinite number of solutions. Each one of the infinite solutions to the first equation is a solution to the second equation, and vice versa.    The graph of one line on coordinate axes. The line has slope -2 and y intercept 5.   The graph of one lines plotted on coordinate axes. The horizontal axis ranges from to and the vertical axis ranges from to . The line has slope and -intercept . The line is bold indicating that both equations produce the same graph. The line is labeled with its defining equation.       "
},
{
  "id": "def-consistent",
  "level": "2",
