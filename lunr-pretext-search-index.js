...
},
{
  ...
  "number": "6.1.4.9",
  "title": "",
  "body": "  Let be the matrix with the number 1 in every entry. Find all eigenvalues and eigenvectors for .    Since is clearly not invertible its columns are linearly dependent it has 0 as an eigenvalue by . A basis for is . The dimension of is .  The other eigenvalue is , and a basis for is .   "
},
{
